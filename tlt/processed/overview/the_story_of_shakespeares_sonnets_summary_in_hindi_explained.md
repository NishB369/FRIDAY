---
title: "Shakespeare's Sonnets — Introduction, Summary, Characters & Background"
video_id: JaRQaB7NU-4
channel: The Literature Talks
published_at: 2021-09-04
duration: 8 minutes
language: Hindi explanation
curriculum: BA English Honours | Renaissance Literature | Poetry | Shakespeare Studies
keywords: ["Shakespeare's sonnets", "Shakespeare sonnets summary", "Shakespeare sonnets background", "Shakespeare sonnets characters", "Fair Youth", "Dark Lady", "Rival Poet", "sonnet sequence", "Shakespearean sonnet form", "sonnet 154", "A Lover's Complaint", "Mr. W.H.", "William Herbert", "Henry Wriothesley", "iambic pentameter", "ABAB CDCD EFEF GG", "sonnet tradition", "Thomas Wyatt", "passage of time", "Shakespeare sonnets Hindi explanation"]
---
...
The Quarto contains:
- **154 sonnets** in sequence
- A narrative poem titled **"A Lover's Complaint"**, which accompanies the sonnets
...
- **Three quatrains** (stanzas of four lines each), each developing a distinct aspect of the central argument or theme
- **A final couplet** (two rhyming lines) that typically provides a resolution, reversal, or ironic conclusion
...
- **Sonnet 126** consists of six couplets (12 lines) and is considered the closing poem of the Fair Youth sequence
- **Sonnet 145** is written in iambic *tetrameter* (8 syllables per line) rather than pentameter
...
- **The Fair Youth sequence (Sonnets 1–126):** The primary addressee is a young man, not a woman. This introduces a complex emotional and possibly homoerotic dimension absent from conventional sonnet sequences.
- **The Dark Lady sequence (Sonnets 127–154):** The female figure is not fair, not chaste, and not idealized. She is described as dark in colouring, morally ambiguous, and sexually enthralling — the antithesis of the Petrarchan ideal.
...
- **William Herbert, Earl of Pembroke** — one of the dedicatees of the First Folio of Shakespeare's plays (1623), lending credibility to a connection with Shakespeare's circle
- **Henry Wriothesley, Earl of Southampton** — Shakespeare's known patron, to whom he dedicated *Venus and Adonis* (1593) and *The Rape of Lucrece* (1594); the initials W.H. could represent the reversal of H.W.
...
- **Sonnet:** A 14-line lyric poem, typically in iambic pentameter. The Shakespearean sonnet has the rhyme scheme ABAB CDCD EFEF GG.
- **Iambic pentameter:** The metre of the sonnets — ten syllables per line in five iambic (unstressed-stressed) feet.
- **Quatrain:** A four-line stanza. The Shakespearean sonnet has three quatrains.
- **Couplet:** A pair of rhyming lines. The concluding couplet of a Shakespearean sonnet often provides a turn or resolution.
- **Volta (turn):** A shift in argument, tone, or perspective within a sonnet. In Shakespearean sonnets, the volta typically occurs at or near the final couplet.
- **Petrarchan convention:** The tradition of idealising a fair, unattainable female beloved, established by Petrarch and imitated across Renaissance Europe.
- **Fair Youth:** The young man addressed in Sonnets 1–126.
- **Dark Lady:** The morally complex, dark-complexioned woman addressed in Sonnets 127–154.
- **Rival Poet:** A competing poet mentioned in Sonnets 78–86, whose identity remains unknown.
- **Procreation sonnets:** Sonnets 1–17, which urge the Fair Youth to marry and have children to preserve his beauty.
- **Sonnet sequence:** A series of sonnets connected by a common speaker, addressee, and thematic preoccupations.
- **Blazon:** A conventional poetic device cataloguing a beloved's physical features — Shakespeare often employs anti-blazon (reversing conventional praise) in the Dark Lady sonnets.
- **Anti-Petrarchan:** A mode that deliberately subverts or parodies Petrarchan conventions of idealized female beauty and male suffering.
...
- Shakespeare's sonnets were first published in 1609 in a Quarto by publisher **Thomas Thorpe**; the collection contains **154 sonnets** plus the narrative poem **"A Lover's Complaint."**
- The sonnets are divided into two major sequences: **Sonnets 1–126 (Fair Youth)** and **Sonnets 127–154 (Dark Lady)**, with the **Rival Poet** sonnets embedded within the Fair Youth sequence (approx. 78–86).
- The **Shakespearean sonnet form** = 3 quatrains + 1 couplet | Iambic pentameter | Rhyme scheme: **ABAB CDCD EFEF GG**
- The sonnet tradition was introduced to English literature in the **16th century**, primarily by **Sir Thomas Wyatt** and Henry Howard (Earl of Surrey).
- Shakespeare's sonnets differ from the **Petrarchan tradition** by addressing a **young man** (not a fair lady) in the primary sequence and presenting a **dark, morally complex woman** rather than an idealized beloved.
- The dedication of the 1609 Quarto to **"Mr. W.H."** is one of the most debated mysteries in English literary history; leading candidates are **William Herbert** (Earl of Pembroke) and **Henry Wriothesley** (Earl of Southampton).
- Major themes: **passage of time**, **love** (in multiple forms), **infidelity**, **the immortalising power of poetry**, and **the transience of beauty**.
- Three major characters: **The Fair Youth** (Sonnets 1–126), **The Dark Lady** (Sonnets 127–154), **The Rival Poet** (identity unknown).
- Notable exceptions in the sequence: Sonnet 99 (15 lines), Sonnet 126 (12 lines / 6 couplets), Sonnet 145 (iambic tetrameter).
- For exams: Be able to distinguish the Shakespearean sonnet from the Petrarchan sonnet in terms of **structure, rhyme scheme, and thematic conventions**; know the identity debates around W.H. and the Rival Poet; and understand the significance of the Dark Lady as an anti-Petrarchan figure.
